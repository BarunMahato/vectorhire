...
import type { Recruiter } from "../RecruiterMatchList";
  ...
  return (
    <main className="space-y-10">
      <section className="bg-slate-900 rounded-[40px] p-10 text-white shadow-2xl relative overflow-hidden">
        <div className="relative z-10">
          ...
          <p className="text-slate-400 font-medium max-w-md">
            Maya found <span className="text-white font-bold">{matches.length} recruiters</span> currently hiring for <span className="text-blue-400 italic">{myRole || "open roles"}</span>.
          </p>
        </div>
      ...
      <div className="space-y-6">
        ...
        {matches.length > 0 ? (
          <RecruiterMatchList
            recruiters={matches as Recruiter[]}
